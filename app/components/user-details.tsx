...
export function UserDetails() {
  ...
  return (
    <div className="p-16 rounded-lg items-center border-[#EDEDED] bg-[#F1F1F2]">
      <div className="p-8 rounded-xl items-center bg-white shadow-[0_5px_15px_rgba(0,0,0,0.08),0_15px_35px_-5px_rgba(25,28,33,0.2)] ring-1 ring-gray-950/5 max-w-[25rem]">
